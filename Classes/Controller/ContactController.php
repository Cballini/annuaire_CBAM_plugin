...
class ContactController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * contactRepository
     *
     * @var \CBAM\CbamAnnuairecbam\Domain\Repository\ContactRepository
     * @inject
     */
     ...
     * action show
     *
     * @param \CBAM\CbamAnnuairecbam\Domain\Model\Contact $contact
     * @return void
     */
    public function showAction(\CBAM\CbamAnnuairecbam\Domain\Model\Contact $contact)
    {
